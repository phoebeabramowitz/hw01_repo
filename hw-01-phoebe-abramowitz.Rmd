...
e)When you apply as.list() to a data frame, 
...
```
These plots demonstrate that way_mpg,city_mpg, then horespower,engine size, bore,curb weight,width,length,and wheel base contribute largely to PC2. This makes sense as the latter group is highly negatively correlated with the former. Similarly, peak rpm and compression ration contribute heavily to PC1.
